...
export const ADVANCED_GROUPS: { title: string; rows: AssumptionRowDef[] }[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      pct({ key: "sp17d", label: "Debiti fornitori oltre %", fields: ["sp17d_growth_pct"], nullable: true }),
      pct({ key: "sp17e", label: "Debiti tributari oltre %", fields: ["sp17e_growth_pct"], nullable: true }),
      pct({ key: "sp17f", label: "Debiti previdenziali oltre %", fields: ["sp17f_growth_pct"], nullable: true }),
      pct({ key: "sp17g", label: "Altri debiti oltre %", fields: ["sp17g_growth_pct"], nullable: true }),
  ...
  },
  {
    ...
    rows: [
      ...
      { key: "tax-advances", label: "Acconti imposte versati €", kind: "eur",
        fields: ["tax_advances_paid"], min: 0, step: "1000",
