...
| Doc | Cosa copre |
|-----|------------|
| [PRATICA-PERCORSO.md](frontend/PRATICA-PERCORSO.md) | Il percorso «Pratica»: gate e barra azioni, riidratazione con retry, Proiezione e Stampa con freschezza dei commenti AI |
...
| [INDICATORI-E-STAMPA.md](frontend/INDICATORI-E-STAMPA.md) | Grafici condivisi, precisione dei valori, regole di stampa/PDF e avviso sui commenti AI obsoleti |
