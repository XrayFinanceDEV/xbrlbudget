...
class IVCEEMapper:
    ...
    # NOTA 2026-07-27: qui vivevano extract_from_tables e
    # extract_income_from_tables — ~330 righe con ~60 etichette letterali,
    # residuo dell'estrazione via Docling. Nessun chiamante in tutto il repo
    # (verificato): l'estrazione IV-CEE passa da pdf_extractor_llm e da
    # standard_ivcee_parser. Rimossi per non lasciare in giro un secondo
    # dizionario di grafie che nessuno aggiorna. validate_balance, poco
    # sotto, e' invece IN PRODUZIONE.
