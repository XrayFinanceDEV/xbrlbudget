...
CASI = [
    dict(
        ...
        prima={
            ...
            2029: ("60802.57", "380845.35", "93573.64", "7175.01", "36209.50"),
        },
    ),
    dict(
        ...
        prima={
            ...
            2030: ("35802.47", "515397.87", "110321.19", "5990.00", "42690.17"),
        },
    ),
    dict(
    ...
    dict(
        ...
        prima={
            ...
            2029: ("79321.08", "396973.99", "92745.83", "8323.16", "35889.16"),
        },
    ),
    dict(
...
PRIMA_SWEEP = {
    ...
    2029: ("38456.35", "358499.13", "93573.64", "7175.01", "36209.50"),
...
OLTRE_IL_PREGRESSO = dict(
    ...
    cassa=("131191.48", "230036.16", "345042.89", "476723.82", "650608.13"),
