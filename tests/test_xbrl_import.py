...
def test_xbrl_import():
    """Test XBRL import functionality"""

    print("=" * 70)
    print("XBRL IMPORT TEST")
    print("=" * 70)
    ...
    try:
        # Test 1: Import XBRL with automatic company creation
        print("\n1. Importing XBRL file (auto-create company)...")
        ...
        if len(years) >= 2:
            ...
            revenue_growth = ((inc1.revenue - inc2.revenue) / inc2.revenue) * 100
            profit_growth = ((inc1.net_profit - inc2.net_profit) / inc2.net_profit) * 100
            asset_growth = ((bs1.total_assets - bs2.total_assets) / bs2.total_assets) * 100
            equity_growth = ((bs1.total_equity - bs2.total_equity) / bs2.total_equity) * 100
        ...
        print(f"- Balance sheets balanced: {bs_current.is_balanced()}")
