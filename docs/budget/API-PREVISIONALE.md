...
entrambi i motori applicano il sacco in coda al calcolo dello SP (`forecast_engine.py:1553`,
`intra_year_engine.py:571`), e il ramo a 12 mesi del wizard della pratica ne manda una versione
propria, con tutte le voci SP del periodo (`app/pratica/page.tsx:872`).
