...
**Off:** the engine **raises**, `Unfunded financing requirement <importo>`, and produces nothing; the
...
threshold (see the Working capital bullet above) — measured on the parity bench: `holding__crescita`
